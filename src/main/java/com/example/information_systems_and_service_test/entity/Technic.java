...
public class Technic {
    @Id
    @GeneratedValue(strategy = GenerationType.SEQUENCE, generator = "technic_id_seq")
    @SequenceGenerator(name = "technic_id_seq", sequenceName = "technic_id_seq", allocationSize = 1)
    @Column(name = "id")
    private Integer id;
